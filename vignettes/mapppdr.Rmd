...
You can also use spatial information to subset count data using the `sf` [package tools](https://github.com/rstudio/cheatsheets/blob/master/sf.pdf). For example, the following code selects counts from the 22 sites within 100 km of ACUN (including ACUN itself):
