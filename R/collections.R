#' Citation information for books or conference proceedings referenced in the APBP database
#'
#' A dataset containing citation information specific to books or conference proceedings
#' containing data included in the APBP database.
#'
#' @format A data frame with `r dim(collections)[1]` rows and 11 variables:
#' \describe{
