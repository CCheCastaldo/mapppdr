#' Citation information for persons referenced in MAPPPD
#'
#' A dataset containing citation information specific to unpublished
#'  data included in MAPPPD.
#'
...
#'   \item{type}{type of unpublished data}
