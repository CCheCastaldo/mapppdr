...
* `penguin_obs` - data frame containing the publicly available *Pygoscelis* and Emperor penguin counts and presence-absence data at breeding sites south of 60 degrees S latitude
...
* `sites_sf` - `sites` data frame with locations stored as a simple feature
...
* `penmap` -  function that creates a leaflet map of all known *Pygoscelis* and Emperor penguin breeding sites south of 60 degrees S latitude
